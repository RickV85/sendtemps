    ...
    <div className='home-welcome-msg-div'>
      ...
      {userInfo === undefined ? null : (
        <div className='home-welcome-content'>
          ...
          <p>
            Select a location to view highly-accurate, NOAA pinpoint forecasts for your backcountry
            adventures!
            <br />
            <br />
            {userInfo ? (
            ...
            So I decided to build this straight-forward, ad-free app for my fellow Front-Rangers to
            easily get an accurate forecast for their own backcountry adventures!
            <br />
            <br />
            New features are coming soon! If you have feedback or feature suggestions, please email
            me at rickv85@gmail.com.
          </p>
        </div>
      )}
    </div>
